...
\begin{proof}
    ...
    \InsertBoxL{0}{
        \begin{minipage}[t]{6cm} 
            \includegraphics[width=\linewidth]{16_cylindr.pdf} 
        \end{minipage}
    }
...
\begin{thm}[Объём тела вращения]\label{16:2}

    ~

    \InsertBoxL{0}{
        \begin{minipage}[t]{6cm} 
            \includegraphics[width=\linewidth]{16_rotation.pdf} 
        \end{minipage}
    }
...
\begin{example}[Объём \strike{арбуза} эллипсоида]
    ...
    \InsertBoxL{0}{
        \begin{minipage}[t]{6cm} 
            \includegraphics[width=\linewidth]{16_elips.pdf} 
        \end{minipage}
    }
...
\begin{example}[Объём полнотория]
    ...
    \InsertBoxL{0}{
        \begin{minipage}[t]{6cm} 
            \includegraphics[width=\linewidth]{16_tor.pdf} 
        \end{minipage}
    }
